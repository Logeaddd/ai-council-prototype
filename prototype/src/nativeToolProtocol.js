...
const TOOL_SPECS = {
  ...
  provision_tool: spec("Detect, acquire, and verify a missing runtime or CLI, with source provenance and optional SHA-256 verification for downloads.", ["toolName", "commandName", "packageId", "installCommand", "downloadUrl", "sha256", "maxDownloadBytes", "executablePath", "verifyCommand", "timeoutMs"], ["toolName"]),
