  ...
  return [
    {
      ...
      content: [
        ...
        "Only an [Execution owner] may create bounded sub-work with task_delegations. Each item needs type (research, implementation, or unblocker), assignee_id, task, expected_evidence, allowed_tools, allow_workspace_mutation, and allowed_paths when mutation is allowed. Delegate a narrow fact, repair, or implementation slice, never the entire user request or final delivery ownership. A contributor must return delegation_handoff with the exact delegation_id, a concise summary, and concrete evidence; do not claim another member's work or independently declare the whole task complete.",
