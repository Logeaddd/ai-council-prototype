  ...
  return [
    {
      ...
      content: [
        ...
        "Only an [Execution owner] may create bounded sub-work. Use the native delegate_task tool for every new delegation; do not merely say in prose that you will delegate. It requires delegationType (research, implementation, or unblocker), assigneeId, task, expectedEvidence, allowedTools, allowWorkspaceMutation, and allowedPaths when mutation is allowed. The task_delegations JSON field remains only for older persisted-provider compatibility. Delegate a narrow fact, repair, or implementation slice, never the entire user request or final delivery ownership. A contributor must return delegation_handoff with the exact delegation_id, a concise summary, and concrete evidence; do not claim another member's work or independently declare the whole task complete.",
